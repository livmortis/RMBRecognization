...
def init_args():
    ...
    args.add_argument('-i',
                      ...
                      # default='../../../../../dataset_formal/detect_data/polyImg_CTPN_train/poly_CTPN_train')   #训练集和验证集数据
                      # default='../../../../../dataset_formal/detect_data/polyImg_CTPN_test/poly_CTPN_test')            #测试集数据
                      # default='../../../../../dataset_formal/detect_data/polyImg_CTPN_train_1800')   #分9面值时，训练集和验证集数据
                      default='../../../../../dataset_formal/detect_data/polyImg_CTPN_test_1800')            #分9面值时，测试集数据
    args.add_argument('-l',
                      '--label_file',
                      type=str,
    ...
    args.add_argument('-s',
                      ...
                      # default='../../../../../dataset_formal/classify_data/crnnData/train_byCTPN_MDB')   #训练集存储位置
                      # default='../../../../../dataset_formal/classify_data/crnnData/val_byCTPN_MDB')   #验证集存储位置
                      # default='../../../../../dataset_formal/classify_data/crnnData/test_byCTPN_MDB')   #测试集存储位置
                      # default='../../../../../dataset_formal/classify_data/crnnData/train_9mianzhi_MDB')   #分9面值时，训练集存储位置
                      # default='../../../../../dataset_formal/classify_data/crnnData/val_9mianzhi_MDB')   #分9面值时，验证集存储位置
                      default='../../../../../dataset_formal/classify_data/crnnData/test_9mianzhi_MDB')   #分9面值时，测试集存储位置
    args.add_argument('-m',
                      '--map_size',
